...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,30&height=220&section=header&text=RENT%20CAR%20BOGOTA&fontSize=52&fontColor=FFD700&fontAlignY=42&desc=🚗%20Vanilla%20JS%20E-Commerce%20%C2%B7%20Vehicle%20Rental%20Storefront&descAlignY=62&descColor=DCDCDC&animation=fadeIn" width="100%"/>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Share+Tech+Mono&weight=700&size=20&duration=2800&pause=900&color=FFD700&center=true&vCenter=true&width=760&lines=%F0%9F%9A%97+Local+Vehicle+Rental+E-Commerce;%E2%9A%A1+Pure+HTML%2C+CSS+%26+JavaScript;%F0%9F%93%B9+Video-Enhanced+Storefront;%F0%9F%93%B1+Responsive%2C+Lightweight+Design;%F0%9F%8F%86+%231+GitHub+Committer+in+Colombia)](https://git.io/typing-svg)
...
<p align="center">
  <a href="https://nietodeveloper.github.io/RentCar/">
    <img src="https://img.shields.io/badge/🌐_Live_Site-nietodeveloper.github.io-FFD700?style=for-the-badge"/>
  </a>
  <a href="https://github.com/NietoDeveloper/RentCar">
    <img src="https://img.shields.io/badge/📂_Source-NietoDeveloper%2FRentCar-000000?style=for-the-badge&logo=github&logoColor=FFD700"/>
  </a>
</p>
...
Welcome to **Rent Car Bogota!** This site serves as an e-commerce storefront for a local vehicle rental business in Bogotá, Colombia. Built entirely with **vanilla JavaScript**, **CSS**, and **HTML** — no frameworks or dependencies required. This build served as the client's MVP, and the design it demonstrated led directly to the client's decision to purchase the full website.
...
└── assets/
    ...
    ├── img/            # Vehicle images
    ├── js/               # JavaScript logic
    └── video/              # Promotional / showcase video assets
```

---

## 🔄 Rental Browsing Flow
...
flowchart LR
    ...
    D -->|Plays| F[assets/video\nShowcase Media]
    E --> G([🚗 Rent Car Storefront])
    F --> G
...
```bash
git clone https://github.com/NietoDeveloper/RentCar
```
